...
import { Form, Input, Button, Typography, message, Skeleton } from 'antd';
...
const VenueLocationSearch = ({ form, mapPreviewUrl, setMapPreviewUrl }) => {
    ...
    return (
        <div style={{ position: 'relative' }}>
                ...
                >
                    <div style={{ padding: '8px 12px', background: '#fafafa', borderBottom: '1px solid #f0f0f0' }}>
                        <Text type="secondary" style={{ fontSize: 12 }}>
                            {loading
                                ? 'Đang tìm kiếm...'
                                : `Kết quả tìm kiếm (${searchResults.length}) - Chọn địa điểm đúng nhất:`}
                        </Text>
                    </div>
            ...
            {!loading && searchResults.length === 0 && <div style={{ marginBottom: 24 }} />}

            <Form.Item name="map_embed_code" label="Vị trí trên bản đồ" hidden>
                <Input.TextArea />
            </Form.Item>
